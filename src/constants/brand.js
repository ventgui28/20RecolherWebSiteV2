export const BRAND = {
  name: "20recolher",
  fullName: "20recolher - Gestão de Resíduos",
  slogan: "Transformando o lixo em futuro",
  ...
  values: [
    ...
    { title: "Inovação", desc: "Utilização das melhores práticas de gestão de resíduos tecnológicos.", icon: "💡" }
  ]
};
