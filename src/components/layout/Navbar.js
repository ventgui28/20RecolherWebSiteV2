...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-[100] bg-green-mist/80 backdrop-blur-xl border-b border-green-50/50">
      <Container>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 md:hidden bg-green-mist bg-grain z-[100] flex flex-col pt-32 pb-12 overflow-hidden"
          >
